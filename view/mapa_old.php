...
<div id="conteudo">
    <!--div id="teste" style="z-index: 3;position: absolute;background-color:#FFF;border: 1px solid #bdbdbd"><img src="img/teste.gif"/></div-->
    ...
    <div id="flashContent">
        ...
        <div id="flash" style="z-index: 9; position: relative">
    <noscript>
