...
a.newlink:hover {color:#f00; font-family:verdana; font-size:14px; font-weight:bold; text-decoration:none;}
  ...
  <body style="margin-left: 10px;margin-top: 10px">
      <div id="titulo"  style="width: 525px;border: 1px solid #000;border-bottom: 1px solid #DFDFDF; background:#DFDFDF;padding: 5px 5px">
          &nbsp;&nbsp; <a href="pdf/<?php echo $objLoc->getMunId()?>_Analise.pdf" title="Análise Municipal" target="_blank"><img border="0" src="img/icone_analise.gif" title="Análise Municipal"/></a>
          <a href="#" id="btnprint"><img src="img/icone_print.gif"/></a><a href="sintese_export.php?texp=csv&munId=<?php echo $munId?>" id="btncsv"><img src="img/icone_csv.gif"/></a><a href="sintese_export.php?texp=xls&munId=<?php echo $munId?>" id="btnexcel"><img src="img/icone_excel.gif"/></a><span id="btn_fechar"><a id='fecharsintese'>Fechar</a></span>
      </div>
